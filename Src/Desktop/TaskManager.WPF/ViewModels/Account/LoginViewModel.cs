namespace TaskManager.WPF.ViewModels
{
    ...
    public class LoginViewModel : Screen
    {
        ...
        public async void LoginButton()
        {
            ...
            try
            {
                ValidationResult validationLogin = new ValidationResult { IsValid = true, Message = "Sucesso" };
               

                var validationResult = validationLogin; //  await helper.ExternlLoginAsync(this.LoginTextBox, this.PasswordTextBox);
